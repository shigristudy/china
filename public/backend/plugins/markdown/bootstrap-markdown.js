        ...
        for (y = 0; y < btnGroups.length; y++) {
          ...
          var z,
            ...
            btnGroupContainer = $('<div/>', {
              'class': 'btn-group mr-2 mb-2 mb-md-0'
            });
          ...
          for (z = 0; z < buttons.length; z++) {
            ...
            buttonContainer.text(' ' + this.__localize(btnText)).addClass('btn-primary btn-sm').addClass(btnClass);
            if (btnClass.match(/btn\-(primary|success|info|warning|danger|link)/)) {
              buttonContainer.removeClass('btn-primary');
            }
